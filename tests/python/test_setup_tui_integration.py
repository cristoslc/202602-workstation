    ...
    return PlaybookManifest(
        ...
        phases=(
            ...
            DiscoveredPhase(
                ...
                roles=(
                    DiscoveredRole("word", ("word", "bureau-veritas"), ""),
                    DiscoveredRole("excel", ("excel", "bureau-veritas"), ""),
                    DiscoveredRole("powerpoint", ("powerpoint", "bureau-veritas"), ""),
                    DiscoveredRole("outlook", ("outlook", "bureau-veritas"), ""),
                    DiscoveredRole("edge", ("edge", "bureau-veritas"), ""),
                    DiscoveredRole("onedrive", ("onedrive", "bureau-veritas"), ""),
                    DiscoveredRole("teams", ("teams", "bureau-veritas"), ""),
                ),
            ),
        ),
    )
