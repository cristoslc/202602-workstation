...
|----|-------|------|--------|-------|
| SPIKE-003 | [Backup Solution Evaluation](./Active/(SPIKE-003)-Backup-Solution-Evaluation/(SPIKE-003)-Backup-Solution-Evaluation.md) | 2026-02-26 | e7a258a | Restic vs Kopia vs BorgBackup |
| SPIKE-005 | [Sync App Settings](./Active/(SPIKE-005)-Sync-App-Settings/(SPIKE-005)-Sync-App-Settings.md) | 2026-02-25 | 85c953e | Stow + Ansible coverage audit |
| SPIKE-006 | [Sync User Folders](./Active/(SPIKE-006)-Sync-User-Folders/(SPIKE-006)-Sync-User-Folders.md) | 2026-02-26 | f14b1e7 | Syncthing + Unison evaluation |
