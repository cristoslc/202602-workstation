...
| ID | Title | Date | Commit | Notes |
|----|-------|------|--------|-------|
| STORY-007 | [1Password Age Key Retrieval]((STORY-007)-1Password-Age-Key-Retrieval.md) | 2026-03-05 | — | 1Password CLI retrieval with biometric auth + error handling (EPIC-004) |
...
| STORY-011 | [Cross-Platform CI]((STORY-011)-Cross-Platform-CI.md) | 2026-03-05 | — | macOS + Linux matrix CI with all lint/syntax/test checks (EPIC-004) |
